        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Equipo = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BancoPreguntas_Competencias_CompetenciaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipos_Competencias_CompetenciaId",
                        column: x => x.CompetenciaId,
                        principalTable: "Competencias",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resultados_Competencias_CompetenciaId",
                        column: x => x.CompetenciaId,
                        principalTable: "Competencias",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Resultados_Equipos_EquipoId",
                        column: x => x.EquipoId,
                        principalTable: "Equipos",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BancoPreguntas_CompetenciaId",
                table: "BancoPreguntas",
                column: "CompetenciaId");

            migrationBuilder.CreateIndex(
                name: "IX_Equipos_CompetenciaId",
                table: "Equipos",
                column: "CompetenciaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resultados_CompetenciaId",
                table: "Resultados",
                column: "CompetenciaId");

            migrationBuilder.CreateIndex(
                name: "IX_Resultados_EquipoId",
                table: "Resultados",
                column: "EquipoId");
        }
